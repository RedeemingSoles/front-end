...
class ShoesRequestForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = props.shoes ? props.shoes : defaultState;
    autoBind.call(this, ShoesRequestForm);
  }
  ...
  render() {
    ...
    return (
      <form className="shoes-request-form" onSubmit={this.handleSubmit}>
        <input
          className="childName"
          type="text"
          name="childName"
...
ShoesRequestForm.propTypes = {
  onComplete: PropTypes.func,
  shoes: PropTypes.object,
  buttonText: PropTypes.string,
};

export default ShoesRequestForm;
import React from 'react';
import PropTypes from 'prop-types';
import autoBind from '../../utils/auto-bind';
